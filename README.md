...
> 💡 **안내**: 본 웹앱은 **인디스쿨 경제금융교육연구회('경북 경금교 x 대구 경금교')**의 6학년 경제금융 수업 자료(2023.05. 리뉴얼 버전)의 흐름과 구성을 교실에서 편리하게 사용할 수 있도록 구현한 웹 애플리케이션입니다.

### 🌟 주요 기능 및 편의 사항
- **자동 현금화 정산**: 각 라운드(시대)가 종료되어 다음 시대로 진행될 때, 학생들이 보유한 모든 주식이 해당 시대의 종가로 **자동 전량 매도(현금화)**되어 다음 시대의 자본금에 예금 및 이자와 함께 합산됩니다.
- **최대 매수 편의 버튼**: 주식 수량 조절 UI에 `최대` 버튼이 추가되어, 학생들이 현재 남은 잔액 범위 내에서 해당 주식을 살 수 있는 최대 수량을 한 번에 편리하게 입력할 수 있습니다.
- **시대별 자산 변화 그래프**: 게임이 완전히 종료된 최종 피날레 화면에서 시작 시점부터 7라운드까지 본인의 시대별 총 자산 변화 추이를 미려한 **꺾은선 차트(SVG)**로 직접 확인하며 주가 흐름과 경제 사건을 깊이 성찰할 수 있습니다.
...
본 시뮬레이션 게임의 수업 모형 및 시나리오는 인디스쿨 경제금융교육연구회 선생님들의 연구 결과물입니다.

<details>
<summary>💡 제작 참여자 명단 접기/펴기 (클릭)</summary>

### 6학년 ver. 2023.05. 리뉴얼 (인디스쿨 경제금융교육연구회 '경북 경금교 x 대구 경금교')
* 2022.05. 최초 제작 / 2023.05. 리뉴얼
* **수업 설계 및 자료 제작**:
  - 이\*주 (구미봉곡초)
  - 정\*웅 (칠곡인평초)
  - 박\*우 (구미금오초)
  ...
  - 김\*현 (김천부곡초)
* **디자인**:
  - 미리캔버스 / 정\*효 (서울영문초) - 디자인 틀에 덧입히기로 활용
  - 이\*주 (구미봉곡초)
